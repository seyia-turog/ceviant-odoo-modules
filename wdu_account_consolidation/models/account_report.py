...
class AccountReport(models.Model):
    ...
    horizontal_group_ids = fields.Many2many(string="Horizontal Groups", comodel_name='horizontal.group')
    ...
    def _init_options_column_headers(self, options, previous_options=None):
        ...
        if selected_horizontal_group_id:
            horizontal_group = self.env['horizontal.group'].browse(selected_horizontal_group_id)
    ...
    def export_to_pdf(self, options):
        ...
        footer = self.env['ir.actions.report']._render_template("wdu_account_consolidation.internal_layout", values=rcontext)
    ...
    def _get_pdf_export_html(self, options, lines, additional_context=None, template=None):
        ...
        template = custom_print_templates.get('pdf_export_main', 'wdu_account_consolidation.pdf_export_main')
...
class AccountReportHorizontalGroup(models.Model):
    _name = "horizontal.group"
    _description = "Horizontal group for reports"

    name = fields.Char(string="Name", required=True, translate=True)
    rule_ids = fields.One2many(string="Rules", comodel_name='horizontal.group.rule', inverse_name='horizontal_group_id', required=True)
...
class AccountReportHorizontalGroupRule(models.Model):
    ...
    horizontal_group_id = fields.Many2one(string="Horizontal Group", comodel_name='horizontal.group', required=True)
