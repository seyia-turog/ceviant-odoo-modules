...
import { AccountReportController } from "@wdu_account_consolidation/components/account_report/controller";
import { AccountReportButtonsBar } from "@wdu_account_consolidation/components/account_report/buttons_bar/buttons_bar";
import { AccountReportEllipsis } from "@wdu_account_consolidation/components/account_report/ellipsis/ellipsis";
import { AccountReportFilters } from "@wdu_account_consolidation/components/account_report/filters/filters";
import { AccountReportHeader } from "@wdu_account_consolidation/components/account_report/header/header";
import { AccountReportLine } from "@wdu_account_consolidation/components/account_report/line/line";
import { AccountReportLineCell } from "@wdu_account_consolidation/components/account_report/line_cell/line_cell";
import { AccountReportLineName } from "@wdu_account_consolidation/components/account_report/line_name/line_name";
import { AccountReportSearchBar } from "@wdu_account_consolidation/components/account_report/search_bar/search_bar";

export class AccountReport extends Component {
    static template = "wdu_account_consolidation.AccountReport";
    static props = {
        action: Object,
    ...
    getTemplate(name) {
        ...
        return `wdu_account_consolidation.${ name }Customizable`;
    }
