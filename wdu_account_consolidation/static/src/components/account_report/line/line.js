...
import { AccountReportDebugPopover } from "@wdu_account_consolidation/components/account_report/line/popover/debug_popover";

export class AccountReportLine extends Component {
    static template = "wdu_account_consolidation.AccountReportLine";
    static props = {
        lineIndex: Number,
        line: Object,
    };
