...
import { AccountReportCarryoverPopover } from "@wdu_account_consolidation/components/account_report/line_cell/popover/carryover_popover";
import { AccountReportEditPopover } from "@wdu_account_consolidation/components/account_report/line_cell/popover/edit_popover";

import { Component, markup, useState } from "@odoo/owl";

export class AccountReportLineCell extends Component {
    static template = "wdu_account_consolidation.AccountReportLineCell";
    static props = {
        line: {
            type: Object,
            optional: true,
