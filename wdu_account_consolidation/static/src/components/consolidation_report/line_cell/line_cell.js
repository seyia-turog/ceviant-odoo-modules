...
import { AccountReport } from "@wdu_account_consolidation/components/account_report/account_report";
...
export class ConsolidationReportLineCell extends AccountReportLineCell {
    static template = "wdu_account_consolidation.ConsolidationReportLineCell";
    static components = {
        ...super.components,
        Dropdown,
        DropdownItem,
